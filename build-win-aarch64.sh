...
cp native/build-aarch64/src/Release/Areos.exe build/win-aarch64/
cp build/libs/Areos.jar build/win-aarch64/
...
echo Areos.exe aarch64 sha256sum
sha256sum build/win-aarch64/Areos.exe

dumpbin //HEADERS build/win-aarch64/Areos.exe
