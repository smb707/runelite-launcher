...
cp native/build-x86/src/Release/Areos.exe build/win-x86/
cp build/libs/Areos.jar build/win-x86/
...
echo Areos.exe 32bit sha256sum
sha256sum build/win-x86/Areos.exe

dumpbin //HEADERS build/win-x86/Areos.exe
